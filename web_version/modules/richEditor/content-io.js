...
import { getOverlayImagesData, setOverlayImagesData, clearOverlayImages } from './core/overlay/index.js';
...
export function saveCurrentContentCK() {
  ...
  const htmlContent = stripOverlayBlocksFromHTML(state.tinyEditor.getContent());
...
function initModalWindowControls() {
    ...
    if (minBtn) {
        minBtn.addEventListener('click', function () { setModalState('minimized'); });
    }
