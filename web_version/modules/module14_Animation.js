...
export function animate() {
  ...
  if (window._pause3DAnimation) {
    ...
    if (appState.is2DView && typeof appState.refresh2DView === 'function') {
  ...
  if (appState.transitionActive) {
    ...
    if (appState.skySphere && appState.skySphere.material.uniforms) {
      ...
      appState.skySphere.rotation.y += 0.0005 * skySpd;
      appState.skySphere.rotation.x += 0.0001 * skySpd;
      appState.skySphere.rotation.z += 0.00005 * skySpd;
    }
    ...
    for (let it of appState.lineItems) {
      ...
      if (it.line.glowTube) it.line.glowTube.material.opacity = lineSmooth * 1.0 * (appState.lineGlowOpacity ?? 1);
      ...
      if (it.line.particlePoints) it.line.particlePoints.material.opacity = lineSmooth * pVis;
...
if (!appState.simple3D) {
      ...
      if (obj.ring) {
        obj.ring.rotation.x += 0.016 * obj.ringSpeed.rx * factor * ringSpeed;
        obj.ring.rotation.y += 0.016 * obj.ringSpeed.ry * factor * ringSpeed;
        obj.ring.rotation.z += 0.016 * obj.ringSpeed.rz * factor * ringSpeed;
        if (obj.glowRing) {
