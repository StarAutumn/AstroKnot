...
export function toggleChildren() {
  ...
  if (target) {
    for (let n of affected) {
      ...
      if (obj) {
        ...
        if (obj.surfaceGlowSphere) {
          obj.surfaceGlowSphere.visible = true;
    ...
    for (let l of affLines) {
      ...
      l.line.setOpacity(0);
      if (l.line.glowTube) {
        l.line.glowTube.visible = true;
        l.line.glowTube.material.transparent = true;
        l.line.glowTube.material.opacity = 0;
      }
      if (l.line.particlePoints) {
        l.line.particlePoints.visible = true;
        l.line.particlePoints.material.opacity = 0;
      }
  ...
  function step(now) {
    ...
    for (let n of affected) {
      ...
      if (obj) {
        ...
        if (obj.glowSphere && obj.glowSphere.material) { obj.glowSphere.material.transparent = true; obj.glowSphere.material.opacity = opacity; }
    ...
    for (let l of affLines) {
      ...
      if (l.line.glowTube) {
        l.line.glowTube.material.transparent = true;
        l.line.glowTube.material.opacity = (target ? ease : 1 - ease) * 0.45;
      }
      if (l.line.particlePoints) {
        l.line.particlePoints.material.opacity = opacity;
      }
    }
    ...
    if (t >= 1) {
      for (let n of affected) {
        ...
        if (obj) {
          ...
          if (obj.glowSphere && obj.glowSphere.material) { obj.glowSphere.material.transparent = true; obj.glowSphere.material.opacity = 1; }
          ...
          if (obj.surfaceGlowSphere) {
            obj.surfaceGlowSphere.visible = target;
            ...
            if (obj.surfaceGlowSphere.material) {
              obj.surfaceGlowSphere.material.transparent = true;
              obj.surfaceGlowSphere.material.opacity = 1;
            }
          }
        }
      }
      for (let l of affLines) {
        ...
        if (target) {
          ...
          if (l.line.glowTube) {
            l.line.glowTube.visible = true;
            l.line.glowTube.material.transparent = true;
            l.line.glowTube.material.opacity = 1;
          }
          if (l.line.particlePoints) {
            l.line.particlePoints.visible = true;
            l.line.particlePoints.material.opacity = 1;
          }
          if (l.line.trailPointsMerged) l.line.trailPointsMerged.visible = true;
        } else {
          l.line.setOpacity(0);
          if (l.line.glowTube) {
            l.line.glowTube.visible = false;
            l.line.glowTube.material.opacity = 0;
          }
          if (l.line.particlePoints) {
            l.line.particlePoints.visible = false;
            l.line.particlePoints.material.opacity = 0;
          }
          if (l.line.trailPointsMerged) l.line.trailPointsMerged.visible = false;
        }
