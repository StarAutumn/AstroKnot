...
export function saveCurrentProjectData() {
  ...
  const serializedLayers = (appState.layers || []).map(layer => ({
    ...
    positions2D: layer.positions2D ? Object.fromEntries(layer.positions2D) : {}
  }));
  ...
  proj.data = {
    ...
    positions: po,
    positions2D: Object.fromEntries(appState.positions2D),
    collapsed2D: Array.from(appState.collapsed2D),
    nodeRichContents: nr,
