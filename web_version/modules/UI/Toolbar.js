...
import { toggleSimple3DMode, applyUITheme, saveSettingsToStorage } from './Theme.js';
...
export function bindToolbarButtons() {
  ...
  <div style="display:flex; align-items:center; gap:10px; margin-top: 10px; padding-top: 8px; border-top: 1px solid rgba(255,255,255,0.1);">
    <span>\uD83C\uDF19</span>
  ...
  <div style="display:flex; align-items:center; justify-content:space-between; margin-top: 10px; padding-top: 8px; border-top: 1px solid rgba(255,255,255,0.1);">
  ...
  <div style="display:flex; align-items:center; gap:10px; margin-top: 4px; padding-top: 8px; border-top: 1px solid rgba(255,255,255,0.1);">
    <span>\uD83D\uDCAB</span>
  ...
  <div style="display:flex; align-items:center; justify-content:space-between; margin-top: 4px; padding-top: 8px; border-top: 1px solid rgba(255,255,255,0.1);">
  ...
  <div style="margin-top: 10px; padding-top: 8px;">
    <div style="font-size:12px; color:var(--text-secondary); margin-bottom:10px;">\uD83C\uDFA8 UI \u989C\u8272\u4E3B\u9898</div>
    <div style="display:flex; gap:6px; flex-wrap:wrap;">
      <span class="ui-theme-swatch" data-theme="cyan" title="\u9752\u8272" style="display:inline-block;width:28px;height:28px;border-radius:14px;background:#0ff;border:2px solid rgba(255,255,255,0.3);cursor:pointer;"></span>
      <span class="ui-theme-swatch" data-theme="green" title="\u7EFF\u8272" style="display:inline-block;width:28px;height:28px;border-radius:14px;background:#0f8;border:2px solid rgba(255,255,255,0.3);cursor:pointer;"></span>
      <span class="ui-theme-swatch" data-theme="orange" title="\u6A59\u8272" style="display:inline-block;width:28px;height:28px;border-radius:14px;background:#f90;border:2px solid rgba(255,255,255,0.3);cursor:pointer;"></span>
      <span class="ui-theme-swatch" data-theme="purple" title="\u7D2B\u8272" style="display:inline-block;width:28px;height:28px;border-radius:14px;background:#b4f;border:2px solid rgba(255,255,255,0.3);cursor:pointer;"></span>
      <span class="ui-theme-swatch" data-theme="pink" title="\u7C89\u8272" style="display:inline-block;width:28px;height:28px;border-radius:14px;background:#f5a;border:2px solid rgba(255,255,255,0.3);cursor:pointer;"></span>
      <span class="ui-theme-swatch" data-theme="silver" title="\u94F6\u8272" style="display:inline-block;width:28px;height:28px;border-radius:14px;background:#aef;border:2px solid rgba(255,255,255,0.3);cursor:pointer;"></span>
    </div>
  </div>
  </div>
  ...
  <div style="margin-top: 12px;">
    ...
    <style>
      #startupModeSelect option, #startupWindowModeSelect option { background:var(--panel-bg); color:var(--accent-light) !important; }
    </style>
    ...
    <div class="setting-section">
      ...
      <div style="display:flex; gap:8px; align-items:center;">
        <input type="text" id="savePathInput" readonly placeholder="\u672A\u8BBE\u7F6E" 
          style="flex:1; background:rgba(255,255,255,0.05); border:1px solid var(--divider); border-radius:6px; color:var(--accent-light); font-size:12px; padding:6px 10px; outline:none; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
...
`;
      ...
      if (startupModeSelect) {
        startupModeSelect.value = appState.startupMode || '3d_simple';
      ...
      // 绑定 UI 颜色主题色块
      popup.querySelectorAll('.ui-theme-swatch').forEach(function (swatch) {
        swatch.addEventListener('click', function (e) {
          e.stopPropagation();
          applyUITheme(swatch.dataset.theme);
        });
      });
      ...
      glowBtn.addEventListener('click', (e) => {
        ...
        if (window.Taskbar) {
          window.Taskbar.addOrUpdateEditor('settings', {
            ...
            label: '\u8BBE\u7F6E',
            active: true,
            activate: function () { gp.popup.classList.add('windowed'); },
            close: hideSettingsPopup,
            maximize: function () { gp.popup.classList.add('windowed'); },
            minimize: hideSettingsPopup
          });
        }
      });
      ...
      // 最小化按钮
      document.querySelector('#settingsPopup .settings-min-btn')?.addEventListener('click', hideSettingsPopup);
